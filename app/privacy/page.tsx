...
export const metadata: Metadata = {
  title: "개인정보 처리방침",
  description: "Bookmark Link의 개인정보 처리방침 안내 페이지입니다.",
  robots: { index: true, follow: true },
};

const SERVICE_NAME = "Bookmark Link";
const OPERATOR_NAME = "이지안 / 북마크링크";
const CONTACT_EMAIL = "cyzo247@gmail.com";
...
export default function PrivacyPolicyPage() {
  return (
    <div className="mx-auto max-w-3xl px-5 py-12">
      <div className="panel rounded-2xl p-8 text-[var(--text)]">
        <header className="mb-10 border-b border-[var(--inactive)] pb-6">
        ...
        <nav
          aria-label="목차"
          className="mb-12 rounded-lg bg-[var(--surface-hover)] p-5"
        >
        ...
        <section id="s3" className="mb-10 scroll-mt-20">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse border border-[var(--inactive)] text-sm">
              <thead className="bg-[var(--surface-hover)]">
                <tr>
                  <th className="border border-[var(--inactive)] px-3 py-2 text-left">
                    처리 목적
                  </th>
                  <th className="border border-[var(--inactive)] px-3 py-2 text-left">
                    보유 기간
              ...
              <tbody>
                <tr>
                  <td className="border border-[var(--inactive)] px-3 py-2">
                    회원 가입 및 관리
                  </td>
                  <td className="border border-[var(--inactive)] px-3 py-2">
                    회원 탈퇴 시까지
        ...
        <section id="s9" className="mb-10 scroll-mt-20">
          ...
          <div className="rounded-lg bg-[var(--surface-hover)] p-4 leading-relaxed">
            <p>
        ...
        <footer className="mt-16 border-t border-[var(--inactive)] pt-6 text-sm text-[var(--text-sub)]">
